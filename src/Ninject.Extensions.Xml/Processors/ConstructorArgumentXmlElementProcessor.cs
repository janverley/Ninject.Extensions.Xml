...
namespace Ninject.Extensions.Xml.Processors
{
    ...
    public class ConstructorArgumentXmlElementProcessor : AbstractXmlElementProcessor
    {
        ...
        public ConstructorArgumentXmlElementProcessor()
            : base("constructorArgument", new string[0], Tags.HasConstructorArgument)
        {
        }
        ...
        {
            XAttribute nameAttribute = element.RequiredAttribute("name");
            XAttribute valueAttribute = element.RequiredAttribute("value");

            syntax.WithConstructorArgument(nameAttribute.Value, valueAttribute.Value);
        }
    }
}